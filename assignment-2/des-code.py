...
def plotGraph(lis,n,i,I,a=1):
    ...
    for i,li in enumerate(compare):
        ...
        for j,string in enumerate(li):
            fi=''.join([str(x) for x in base[j]]).strip()
            f2=''.join([str(x) for x in compare[i][j]]).strip()
            # appending
            temp.append(HD(fi,f2))
        hamming.append(temp)
...
if __name__ == "__main__" : 
    ...
    plot1=[b'zxcvbnma',b'zxcvbnmz',b'zxcvbnmx',b'zxcvbnmc',b'zxcvbnmv',b'zxcvbnmb']
    plotGraph(getLis(A,plot1,b"zxcvbnma"),"5 plaintexts, HD=1 ",0,1)

    plot2=[b'qwertyui',b'qqertyui',b'qwqrtyui',b'qweqtyui',b'qwerqyui',b'qwertqui']
    plotGraph(getLis(A,plot2,b"zxcvbnma"),"5 plaintexts,increasing HD",1,1)

    k_list=[des(b'abcdefgh'),des(b'xbcdefgh'),des(b'axcdefgh'),des(b'abxdefgh'),des(b'abcxefgh'),des(b'abcdxfgh')]
    k_list1=[b'abcdefgh',b'xbcdefgh',b'axcdefgh',b'abxdefgh',b'abcxefgh',b'abcdxfgh']
    plaintext=b"zxcvbnma"
    ...
    plotGraph(lis,"5 different keys which have HD=1 with the base key",0,0)